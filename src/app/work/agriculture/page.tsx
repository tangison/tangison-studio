...
export const metadata: Metadata = {
  title: "Agriculture & Agro-processing | Work | Tangison Studio",
  description: "Marketplace platforms, cooperative management tools, and agri-tech interfaces for Namibia's farming communities. Tangison Studio builds digital solutions from Windhoek.",
  alternates: { canonical: "/work/agriculture" },
  openGraph: {
    title: "Agriculture & Agro-processing | Work | Tangison Studio",
    description: "Marketplace platforms, cooperative management tools, and agri-tech interfaces for Namibia's farming communities.",
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        { name: "Home", url: "/" },
        { name: "Work", url: "/work" },
        { name: "Agriculture & Agro-processing", url: "/work/agriculture" },
      ]} />
      <WebPageJsonLd
        title="Agriculture & Agro-processing | Work"
        description="Marketplace platforms, cooperative management tools, and agri-tech interfaces for Namibia's farming communities."
        url="/work/agriculture"
      />
