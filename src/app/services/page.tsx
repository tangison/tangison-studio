...
export const metadata: Metadata = {
  ...
  description:
    "Seven outcome-led programs from a single practice in Windhoek. Brand systems, website development, application design, product design, design systems, applied AI.",
