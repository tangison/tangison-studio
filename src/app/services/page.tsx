...
export const metadata: Metadata = buildPageMetadata({
  title: "Services: Brand, Web, Product, AI",
  description:
    "Seven outcome-led programs from The Tangison Studio in Windhoek: brand systems, website development, product design, design systems, and applied AI.",
  path: "/services",
  ogTitle: "Services | The Tangison Studio",
  ogImage: {
    url: "/images/og/services.png",
    width: 1200,
    height: 630,
    alt: "Studio and intelligence services from The Tangison Studio, Windhoek.",
  },
});
...
export default function ServicesPage() {
  return (
    <div className="theme-ink bg-paper text-ink min-h-screen">
      <JsonLdScript
        data={pageJsonLd(
          "Services: Brand, Web, Product, AI | The Tangison Studio",
          "Seven outcome-led programs from The Tangison Studio in Windhoek: brand systems, website development, product design, design systems, and applied AI.",
          "/services",
        )}
      />
