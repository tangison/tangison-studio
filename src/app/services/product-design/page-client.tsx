    ...
    <SiteShell>
      ...
      <section className="pt-36 md:pt-44 pb-20 md:pb-28 px-6 md:px-12 lg:px-20">
        <div className="max-w-[1400px] mx-auto">
          <motion.div {...fadeUp}>
            <span className="font-jetbrains text-[10px] uppercase tracking-[0.3em] text-signal-teal block mb-6">PRODUCT DESIGN</span>
            ...
            <p className="font-satoshi text-lg md:text-xl text-ink-muted max-w-2xl leading-relaxed">
              From concept to launch and beyond. We design products that solve real problems and create lasting value — not just interfaces, but complete experiences backed by strategy, research, and a clear path to market.
            </p>
          </motion.div>
        </div>
      </section>
