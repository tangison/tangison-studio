      ...
      <section className="relative w-full">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative overflow-hidden">
            <Image
              src="/images/services/design-systems.webp"
              alt="Design system documentation showing component library, token variables, and usage guidelines on multiple screens"
              width={1600}
              height={1200}
      ...
      <section className="py-24 bg-atlantic-black">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <p className="font-satoshi text-lg text-fog-gray max-w-2xl mx-auto mb-8">
            We are documenting our design systems projects. Real case studies with measurable outcomes will appear here soon.
          </p>
