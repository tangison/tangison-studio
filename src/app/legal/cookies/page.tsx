...
export const metadata: Metadata = {
  ...
  description: "Cookies Policy for Studio.",
  alternates: { canonical: "/legal/cookies" },
  openGraph: { title: "Cookies Policy | Studio", description: "Cookies Policy for Studio.", url: "/legal/cookies", images: [{ url: "/og.png", width: 1200, height: 630, alt: "Studio" }] },
};
...
export default function Page() {
  return (
    <>
      ...
      <WebPageJsonLd title="Cookies Policy" description="Cookies Policy for Studio." url="/legal/cookies" />
      <SiteShell>
        <section className="pt-12 md:pt-20 pb-20">
          <div className="mx-auto max-w-2xl px-6">
            ...
            <h1 className="font-display font-bold text-ink text-4xl md:text-5xl mb-4">Cookies Policy</h1>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-ink-muted">
              <p>This is the Cookies Policy for Tangison Studio. This page is being prepared with verified legal content. Please contact studio@tangison.com for any questions about this policy.</p>
