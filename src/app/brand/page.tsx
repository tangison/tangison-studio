      ...
      <SiteShell>
        ...
        <section className="py-8">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {colors.map((c) => (
                <div key={c.hex} className="overflow-hidden rounded-[16px] border border-card-border">
        ...
        <section className="py-8">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-[16px] border border-card-border bg-signal-white">
        ...
        <section className="py-8 pb-20">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="p-8 rounded-[24px] border border-card-border bg-signal-white flex items-center gap-6">
