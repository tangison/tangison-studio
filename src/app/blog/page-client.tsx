          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {routeCards.map((card, i) => (
              ...
              >
                <Link
                  href={card.href}
                  className="group block border border-black/[0.06] bg-signal-white p-8 md:p-10 h-full hover:border-black/[0.1] transition-all duration-500"
                >
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredArticles.map((article, i) => (
              ...
              >
                <div className="group border border-black/[0.06] bg-skeleton-bone/40 p-6 md:p-8 h-full flex flex-col">
