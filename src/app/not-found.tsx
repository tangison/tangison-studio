    ...
    <SiteShell>
      <section className="pt-20 pb-20">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <div className="aspect-[16/9] overflow-hidden rounded-[24px] bg-ocean-mist mb-8 max-w-md mx-auto">
            <Image src="/images/paintings/desert-threshold.webp" alt="An oil painting of a foggy passage through weathered rocks, suggesting a lost path." width={800} height={450} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 400px" />
          </div>
