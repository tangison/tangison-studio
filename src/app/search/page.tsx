...
export const metadata: Metadata = {
  ...
  description:
    "Search everything on Studio Tangison: 47 research-backed articles on AI adoption in Namibia, 15 case studies, and every page of the studio.",
    ...
    <div className="theme-ink bg-paper text-ink min-h-screen">
      <section className="mx-auto w-full max-w-[900px] px-6 md:px-12 pt-32 md:pt-40 pb-24 md:pb-32">
        <div className="max-w-2xl">
          ...
          <Reveal delay={60}>
            <h1 className="h1 mt-4">Find it here.</h1>
          </Reveal>
          <Reveal delay={120}>
