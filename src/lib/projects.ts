...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "One accountable structure for a Namibian group across construction, technology, cooling, logistics, fuel and energy, and tourism and agriculture.",
  ...
  },
  {
    ...
    description: "Kalahari-inspired organic skincare formulated for the African market, with ingredient stories and a brand system rooted in Namibian terrain.",
    tags: ["Brand Identity", "Website Design", "Website Development", "E-commerce Setup"],
